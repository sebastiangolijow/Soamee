...
useEffect(() => {
    ...
    return (
        ...
        <Link to='/home'><img className={styles.img} src='https://images.squarespace-cdn.com/content/v1/5e3a928770897e641dceeaab/1589874757659-EY91JGOYIF31K7X9549S/black+and+blue+logo.png' alt='Elastacloud Img'/></Link>  
       <SearchBar></SearchBar>
       <MiniShop></MiniShop>
